...
// Demo sessions when unauthenticated
const DEMO_CITIZEN = {
  userId: "demo-citizen",
      ...
      <div className="flex gap-6 px-4 py-6 lg:px-10">
        ...
        <aside className="hidden lg:flex w-64 flex-col gap-6 rounded-2xl bg-white p-6 shadow-sm">
          ...
          <nav className="space-y-2 text-sm">
            ...
            <SidebarLink icon={Layers} label="Dashboard" href="/dashboard" active />
            <SidebarLink icon={Compass} label="Explore" href="/explore" />
            <SidebarLink icon={BarChart2} label="Regions" href="/regions" />
            <SidebarLink icon={BookOpen} label="Education" href="/education" />
          </nav>
          <div className="mt-auto space-y-3 text-sm">
            ...
            <SidebarLink
              ...
              href={isAuthenticated ? undefined : "/auth"}
            />
          </div>
        </aside>
        ...
        <div className="flex-1">
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex items-center gap-3">
                <div className="hidden md:flex items-center gap-2 rounded-full border border-border px-3 py-2">
                  <Search className="w-4 h-4 text-muted-foreground" />
                  <input className="outline-none text-sm" placeholder="Search projects or updates" />
                </div>
                  ...
                  <div className="space-y-6">
                    {accountRole === "politician" && (
                      <>
                        ...
                        {isPoliticiansError && (
                          <ErrorPanel message="Couldn't load your transparency stats. Please retry." onRetry={() => refetchPoliticians()} />
                        )}
                      ...
                      <div key={idx} className="flex gap-2">
                        <span
                          className={`mt-1 h-2.5 w-2.5 rounded-full ${
                            item.type === "verification" ? "bg-green-500" : item.type === "comment" ? "bg-blue-500" : "bg-amber-500"
                          }`}
                        />
                        <div>
