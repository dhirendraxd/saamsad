...
export const mockPoliticians: Politician[] = [
  {
    ...
    constituency: "Kathmandu Constituency 5 (includes Ward 5)",
    ward: "Ward 5",
    ...
    communityTrust: 82,
    engagementPoints: 164,
    totalPromises: 12,
    completedPromises: 7,
    delayedPromises: 2,
    failedPromises: 1,
    activeProjects: 4,
    badges: ["Member of Parliament", "Minister", "Government Spokesperson"],
    manifesto: "Member of Parliament for Kathmandu Constituency 5 and Minister of Education, Science and Technology (as provided). Focus areas include education reform, governance digitization, youth and sports development, and constituency service delivery across Hadigaun, Bhatbhateni, Bishal Nagar, Tangal, and Sano Gaucharan.",
    verified: true,
  },
  {
    id: "p2",
  ...
  },
  {
    ...
    communityTrust: 81,
    engagementPoints: 122,
    totalPromises: 11,
    completedPromises: 6,
    delayedPromises: 2,
    failedPromises: 1,
    activeProjects: 2,
    badges: ["Former MP", "Former Deputy Prime Minister"],
    manifesto: "Former representative for Kathmandu 5 in the 2074-2079 period.",
    verified: true,
  },
  {
    id: "p8",
    ...
    district: "Kathmandu",
    municipality: "Kathmandu Metropolitan City",
    accountabilityScore: 83,
    transparencyScore: 80,
    communityTrust: 78,
    engagementPoints: 141,
    totalPromises: 9,
    completedPromises: 5,
    delayedPromises: 1,
    failedPromises: 0,
    activeProjects: 2,
    badges: ["Former MP"],
    manifesto: "Former representative for Kathmandu 5 in the 2079-2082 period.",
    verified: true,
  },
  {
    id: "p9",
    ...
    manifesto: "Represented Kathmandu 5 in earlier terms.",
    verified: true,
  },
  {
    id: "p10",
    ...
    activeProjects: 1,
    badges: [],
    manifesto: "Improving public toilets, disability-friendly sidewalks, and monthly open ward accountability sessions.",
    verified: true,
  },
];
...
export const mockProjects: Project[] = [
  ...
  },
  {
    ...
    description: "Replacing damaged roadside drainage lines and adding flood channels in dense lanes across Ward 5.",
    location: "Kathmandu Metropolitan City, Ward 5",
    ward: "Ward 5",
    politicianId: "p1",
    politicianName: "Sasmit Pokharel",
    ...
    evidenceCount: 11,
    commentCount: 19,
    verificationVotes: { completed: 2, inProgress: 41, delayed: 9, notStarted: 3 },
    milestones: [
      { title: "Lane survey complete", date: "2026-02-01", completed: true },
      { title: "Main trenching", date: "2026-04-20", completed: true },
      { title: "Pipe installation", date: "2026-07-30", completed: false },
      { title: "Road restoration", date: "2026-10-15", completed: false },
    ],
    updates: [
      { date: "2026-04-02", content: "Drain channels opened on two major lanes. Pipe installation starts next week.", type: "progress" },
    ],
  },
  {
    id: "proj8",
    title: "Community Water Kiosk Network",
    description: "Installing 6 public drinking water kiosks with filtration and maintenance logs in Ward 5 neighborhoods.",
    location: "Kathmandu Metropolitan City, Ward 5",
    ward: "Ward 5",
    politicianId: "p1",
    politicianName: "Sasmit Pokharel",
    ...
    evidenceCount: 14,
    commentCount: 26,
    verificationVotes: { completed: 4, inProgress: 53, delayed: 6, notStarted: 2 },
    milestones: [
      { title: "Site approvals", date: "2026-02-20", completed: true },
      { title: "First 3 kiosks installed", date: "2026-05-01", completed: true },
      { title: "All kiosks operational", date: "2026-08-30", completed: false },
    ],
    updates: [
      { date: "2026-04-15", content: "Three kiosk foundations completed and filtration units delivered.", type: "progress" },
    ],
  },
];
